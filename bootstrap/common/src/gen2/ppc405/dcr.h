/*!@file   dcr.h
*
* @brief   Definition of DCR space for Gen 1 RCE boards
*
...
* @endverbatim
*/
#ifndef _GEN2_PPC405_DCR_H_
#define _GEN2_PPC405_DCR_H_

#define DCR_I2C_RAM_WORDADDR    0x2F0
#define DCR_I2C_RAM_DATA        0x2F1
#define DCR_I2C_LASTWRITE       0x2F2 // atomic access to I2C_REG_LASTWRITE
#define DCR_I2C_RESPONSE        0x2F3 // ditto to I2C_REG_RESPONSE
