/* --------------------------------------------------------------------- *//*!
  ...
  \file   Unions_little.h
  \brief  Little endian implementation of Union.h
...
\endverbatim
  ...
  This is the little endian implementaion.
                                                                         */
/* --------------------------------------------------------------------- */
...
{
   union _U_byte  lo; /*!< Access the numerically least significant byte */
   union _U_byte  hi; /*!< Access the numerically most  significant byte */
}
U_short_as_bytes;
...
{
  union _U_short lo; /*!< Access the numerically least significant short */
  union _U_short hi; /*!< Access the numerically most  significant short */
}
U_int_as_shorts;
...
{
 union _U_int    lo; /*!< Access the numerically least significant int   */
 union _U_int    hi; /*!< Access the numerically most  significant int   */
}
U_longlong_as_ints;
