/* $Id: xdma_channel.c 1948 2013-08-15 18:48:49Z claus $ */
/******************************************************************************
*
...
* 1.10b hvm  12/01/08 Fixed the VxWorks warnings as per CR487986
* </pre>
*
******************************************************************************/
...
int XDmaChannel_Initialize(XDmaChannel * InstancePtr, u32 BaseAddress)
{
	 ...
	 */
	XVersion_FromString((XVersion *)&InstancePtr->Version, "1.00a");
...
XVersion *XDmaChannel_GetVersion(XDmaChannel * InstancePtr)
{
	...
	return ((XVersion *)&InstancePtr->Version);
}
