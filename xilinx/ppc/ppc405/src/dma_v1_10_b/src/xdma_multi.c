/* $Id: xdma_multi.c 1948 2013-08-15 18:48:49Z claus $ */
/******************************************************************************
*
			 ...
			 u32 BaseAddress, u32 *UserMemoryPtr, u16 ChannelCount)
{
	...
	InstancePtr->SgDataTablePtr =
		(XDmaMulti_SgData *) ((u32) UserMemoryPtr +
				      (ChannelCount * sizeof(u32)));
	...
	for (Channel = 0; Channel < ChannelCount; Channel++) {
		 ...
		 * to use (initialized).
		 */
		CHANNEL_DATA.GetPtr = (XBufDescriptor *) NULL;
		CHANNEL_DATA.PutPtr = (XBufDescriptor *) NULL;
		CHANNEL_DATA.CommitPtr = (XBufDescriptor *) NULL;
		CHANNEL_DATA.LastPtr = (XBufDescriptor *) NULL;
			...
			u32 *SourcePtr, u32 *DestinationPtr, u32 ByteCount)
{
	...
	XIo_Out32(CHANNEL_REGS + XDM_SA_REG_OFFSET, (u32) SourcePtr);

	XIo_Out32(CHANNEL_REGS + XDM_DA_REG_OFFSET, (u32) DestinationPtr);
