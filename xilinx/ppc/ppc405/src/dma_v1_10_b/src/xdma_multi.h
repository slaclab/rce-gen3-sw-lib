/* $Id: xdma_multi.h 1948 2013-08-15 18:48:49Z claus $ */
/******************************************************************************
*
...
typedef struct {
	...
	u16 TotalDescriptorCount;
				/**< Total # of descriptors in the list */
	u16 ActiveDescriptorCount;
 ...
 */
typedef struct {
	u32 BaseAddress;    /**< Base address of channels */
	u32 IntrFifoAddress;/**< Interrupt FIFO address */
	u32 IsReady;	    /**< Device is initialized and ready */
	u16 ChannelCount;   /**< Number of DMA channels on device */
	u32 *AddrTablePtr;  /**< Beginning of Register address table */
	XDmaMulti_SgData *SgDataTablePtr;
				     /**< Beginning of SGDMA data structures */
} XDmaMulti;

/**
 * XDmaMulti_mSizeNeeded is used to calculate the amount of memory needed
 * in the _Initialize call.
 * (sizeof(XDmaMulti_SgData) + sizeof(u32)) is the size required for
 ...
 */
#define XDM_BYTES_PER_CHANNEL   (sizeof(u32) + sizeof(XDmaMulti_SgData))
...
* @note
*
* C Signature: u32 XDmaMulti_mSizeNeeded(u32 NumChannels);
*
*****************************************************************************/
#define XDmaMulti_mSizeNeeded(NumChannels)                                   \
    (u32)((NumChannels) * XDM_BYTES_PER_CHANNEL)
...
* @note
*
* C Signature: u32 XDmaMulti_mGetGlobalControl(XDmaMulti *InstancePtr);
*
*****************************************************************************/
...
* @note
*
* C Signature: u32 XDmaMulti_mGetControl(XDmaMulti *InstancePtr,
*                                            unsigned Channel);
*
*****************************************************************************/
...
* @note
*
* C Signature: u32 XDmaMulti_mGetEventEnable(XDmaMulti *InstancePtr,
*                                                unsigned Channel);
*
*****************************************************************************/
...
* @note
*
* C Signature: u32 XDmaMulti_mGetEventStatus(XDmaMulti *InstancePtr);
*
*****************************************************************************/
...
* @note
*
* C Signature: u32 XDmaMulti_mGetEventChannel(u32 Status);
*
*****************************************************************************/
#define XDmaMulti_mGetEventChannel(Status)                                   \
        ((u32)(((Status) & XDM_GEFIFO_CHAN_MASK) >> XDM_GEFIFO_CHAN_SHIFT))
...
#define XDmaMulti_mGetEventParameter(Status)                                   \
        ((u32)((Status) & XDM_GEFIFO_EVENT_MASK))
...
* @note
*
* C Signature: u32 XDmaMulti_mGetStatus(XDmaMulti *InstancePtr,
*                                           unsigned Channel);
*
*****************************************************************************/
...
* @note
*
* C Signature: u32 XDmaMulti_mGetPktThreshold(XDmaMulti *InstancePtr,
*                                                 unsigned Channel);
*
*****************************************************************************/
...
* @note
*
* C Signature: u32 XDmaMulti_mGetPktWaitBound(XDmaMulti *InstancePtr,
*                                                 unsigned Channel);
*
*****************************************************************************/
 ...
 * Standard functions
 */
int XDmaMulti_Initialize(XDmaMulti * InstancePtr,
			 u32 BaseAddress, u32 *UserMemoryPtr, u16 ChannelCount);
int XDmaMulti_SelfTest(XDmaMulti * InstancePtr);
 ...
 */
int XDmaMulti_SgStart(XDmaMulti * InstancePtr, unsigned Channel);
int XDmaMulti_SgStop(XDmaMulti * InstancePtr, unsigned Channel,
		     XBufDescriptor ** BufDescriptorPtr);
int XDmaMulti_CreateSgList(XDmaMulti * InstancePtr,
			   unsigned Channel, u32 *BdMemoryPtr, u32 ByteCount);
int XDmaMulti_IsSgListEmpty(XDmaMulti * InstancePtr, unsigned Channel);

int XDmaMulti_PutDescriptor(XDmaMulti * InstancePtr, unsigned Channel,
			    XBufDescriptor * BufDescriptorPtr);
int XDmaMulti_CommitPuts(XDmaMulti * InstancePtr, unsigned Channel);
int XDmaMulti_GetDescriptor(XDmaMulti * InstancePtr, unsigned Channel,
			    XBufDescriptor ** BufDescriptorPtr);
