/* $Id: xbuf_descriptor.h 1948 2013-08-15 18:48:49Z claus $ */
/******************************************************************************
*
...
#define XBufDescriptor_IsLastControl(InstancePtr) \
    (int)((*((u32 *)InstancePtr + XBD_CONTROL_OFFSET) & \
...
#define XBufDescriptor_IsLastStatus(InstancePtr) \
    (int)((*((u32 *)InstancePtr + XBD_STATUS_OFFSET) & \
...
#define XBufDescriptor_IsLocked(InstancePtr) \
    (int) ((*((u32 *)InstancePtr + XBD_FLAGS_OFFSET) & \
...
int XBufDescriptor_IsLastControl(XBufDescriptor* InstancePtr);
...
int XBufDescriptor_IsLastStatus(XBufDescriptor* InstancePtr);
...
int XBufDescriptor_IsLocked(XBufDescriptor* InstancePtr);
