...
#include "datCode.hh"
#include DAT_PUBLIC( driver,   network,  configure.hh)
...
struct rtems_bsdnet_config rtems_bsdnet_config = {
  ...
  (char*)"testSystem",           /* Host name */
  (char*)"nowhere.com",          /* Domain name */
  (char*)"127.0.0.1",            /* Gateway */
  (char*)"127.0.0.1",            /* Log host */
  {(char*)"127.0.0.1" },         /* Name server(s) */
  {(char*)"127.0.0.1" },         /* NTP server(s) */
  0,
  0,
  0,
  0,
