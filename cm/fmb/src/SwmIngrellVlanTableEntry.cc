...
#include "fmb/SwmVlanTableEntry.hh"

using Bali::SwmVlanTableEntry;

SwmIngressVlanTableEntry::SwmIngressVlanTableEntry(unsigned port_membership_mask, unsigned port_tag_mask,
