...
$$(syndir)/$(1).edf: $$(syndir)/$(1).prj $$(sdc_$(1)) $$(src_$(1)) $$(ucf_$(1))

$$(syndir)/$(1).prj: $$(synoptions) $$(src_$(1))
endef
...
define design_template
  ...
  edfs_$(1) := $$(call edfs,$$(syndir)/,$$(synplifs_$(1)) $$(syn_$(1)))
  tcls_$(1) := $$(call prjs,$$(syndir)/,$$(synplifs_$(1)) $$(syn_$(1)))
  acefiles  += $$(ace_$(1))
  bitfiles  += $$(bit_$(1))
  twrfiles  += $$(twr_$(1))
  ncdfiles  += $$(ncd_$(1))
...
$$(ngd_$(1)): $$(edfs_$(1)) $$(ngcs_$(1)) $$(ubmm_$(1))
endef
...
#cpo and perazzo eliminated loop over synplify stuff to simplify the makefile system.
$(foreach dsg,$(designs),$(eval $(call synplify_template,$(dsg))))
...
$(pkgdir)/%.ngd:
	...
	$(quiet)cd $(blddir) && \
	$(NGDGEN) $(sdpaths) $(obmm_$*) -uc $(syndir)/synplicity.ucf $(edn_$*) $*.ngd && \
	mv $*.ngd ../
...
# Xilinx XST
$(xstdir)/%.prj:
	@echo "[XP] Generate list of source files for $*"
...
$(syndir)/%.prj:
	...
	$(quiet)$(TCLGEN) $(synoptions) $* $(disiobuf_$*) $(pwd) $(sdc_$*) $(src_$*) $(ucf_$*) $@
